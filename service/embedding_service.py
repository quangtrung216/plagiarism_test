...
class DEk21HCMUTEEmbedding:
    ...
    def __init__(self, model_name: str = "huyydangg/DEk21_hcmute_embedding", device: Optional[str] = None):
        """
        ...
        try:
            ...
            self.model.to(self.device)
            self.logger.warning(f"Using fallback model 'paraphrase-multilingual-MiniLM-L12-v2'")
